...
NFIDD (Nowcasting and Forecasting Infectious Disease Dynamics) is an MIT-licensed library of [sessions](course-info/sessions) for learning about Rt estimation and nowcasting of infectious disease surveillance data.
We have adapted this course for the [SISMID](https://sismid.sph.emory.edu/) course and now further refined it for EMBL-EBI focusing specifically on Rt estimation and nowcasting methods.
This focused course is a living resource designed to help epidemiologists, public health professionals, and researchers understand and apply real-time analysis methods to infectious disease surveillance data.
...
-   Directly download the course material:
    ...
    ::: callout-tip
    [[**Download**]{.underline}](https://github.com/nfidd/EMBL-EBI/archive/refs/heads/main.zip)
    :::

-   Alternatively, if you are familiar with git you can clone the [repo](https://github.com/nfidd/EMBL-EBI).
...
2.  **Download fresh course materials** if using local files:
    ...
    -   Download the latest version: [[**Download**]{.underline}](https://github.com/nfidd/EMBL-EBI/archive/refs/heads/main.zip)
